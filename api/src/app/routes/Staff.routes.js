...
// #7
router.get("/", ...auth, requireScope("isManager", Target.query()), ctrl.list);
// #8
// :id is a STAFF id, not a project — there is no project context to resolve, so this
// degrades to "manages at least one project". See ScopeTarget.util.js.
router.get("/:id", ...auth, requireScope("isManager", Target.anyProject), ctrl.getById);
// #9
...
// broader (finance/owner/admin too, per GLOBAL_ROLES).
